...
<body>
    ...
    <script defer>
        window.onload = function() {
            ...
            ctx.fillText("<?php echo $title; ?>", ctx.canvas.width / 2, ctx.canvas.height / 5 + fontSize / 2);
            ...
            ctx.font = fontType + fontSize + "px" + fontFamiliy;
            ctx.textAlign = "center"
            ctx.fillText("<?php echo $name; ?>", ctx.canvas.width / 2, ctx.canvas.height / 2 - fontSize / 2);
            ...
            ctx.font = fontType + fontSize + "px" + fontFamiliy;
            ctx.textAlign = "center"
            ctx.fillText("<?php echo $headline; ?>", ctx.canvas.width / 2, ctx.canvas.height / 3 - fontSize / 2);
            ...
            ctx.font = fontType + fontSize + "px" + fontFamiliy;
            ctx.textAlign = "center"
            ctx.fillText("We are proudly present this certificate to ", ctx.canvas.width / 2, ctx.canvas.height / 3 + fontSize * 4);
            ...
            ctx.textAlign = "center"
            ctx.fillText("<?php echo $description; ?>", ctx.canvas.width / 2, ctx.canvas.height / 2 + fontSize * 2);
        }
    </script>
</body>
